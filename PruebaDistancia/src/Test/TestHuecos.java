...
public class TestHuecos {
    ...
    public static void main(String[] args) throws IOException {
        ...
        GAP g = new GAP();
        g.ocurrencia(x, x.length);
       
        g.intervalosOcurrencia();
        g.frecuencias();
        g.frecuenciaAcumulada(x);
        g.frecuenciaAcumuladaR();
        g.diferenciaFrecuencias();
        //double[]dif = g.diferenciaFrecuencias(f, far);
